...
int main(int argc, char **argv)
{
     ...
     */
    ros::init(argc, argv, "jack_velpub");
     ...
     */
    ros::Publisher jack_velpub = n.advertise<geometry_msgs::Twist>("/robi/cmd_vel", 1000);
    ...
    while (ros::ok())
    {
        ...
        if (nh.hasParam("/jack_linvel_res") && nh.hasParam("/jack_angvel_res")){
            ...
            // show what you got
            ROS_DEBUG_STREAM("params found");
        }
        else {
            ROS_DEBUG_STREAM("params not found");
        }
