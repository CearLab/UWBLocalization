...
class PozyxRangingWithCir {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('cir')) {
        this.cir = initObj.cir
      }
      else {
        this.cir = [];
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [cir]
    bufferOffset = _arraySerializer.int16(obj.cir, buffer, bufferOffset, null);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PozyxRangingWithCir(null);
    ...
    // Deserialize message field [cir]
    data.cir = _arrayDeserializer.int16(buffer, bufferOffset, null)
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += 2 * object.cir.length;
    return length + 76;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PozyxRangingWithCir(null);
    ...
    if (msg.cir !== undefined) {
      resolved.cir = msg.cir;
    }
    else {
      resolved.cir = []
    }
...
module.exports = PozyxRangingWithCir;
