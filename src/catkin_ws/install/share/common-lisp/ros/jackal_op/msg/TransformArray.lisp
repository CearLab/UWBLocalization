...
(cl:defmethod cl:initialize-instance :after ((m <TransformArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TransformArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jackal_op-msg:<TransformArray> is deprecated: use jackal_op-msg:TransformArray instead.")))

(cl:ensure-generic-function 'transforms-val :lambda-list '(m))
(cl:defmethod transforms-val ((m <TransformArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jackal_op-msg:transforms-val is deprecated.  Use jackal_op-msg:transforms instead.")
  (transforms m))
