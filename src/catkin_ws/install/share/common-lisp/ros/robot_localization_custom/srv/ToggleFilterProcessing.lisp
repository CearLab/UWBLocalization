...
(cl:defmethod cl:initialize-instance :after ((m <ToggleFilterProcessing-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ToggleFilterProcessing-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_localization_custom-srv:<ToggleFilterProcessing-request> is deprecated: use robot_localization_custom-srv:ToggleFilterProcessing-request instead.")))

(cl:ensure-generic-function 'on-val :lambda-list '(m))
(cl:defmethod on-val ((m <ToggleFilterProcessing-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_localization_custom-srv:on-val is deprecated.  Use robot_localization_custom-srv:on instead.")
  (on m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ToggleFilterProcessing-request>)))
  ...
  "robot_localization_custom/ToggleFilterProcessingRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ToggleFilterProcessing-request)))
  "Returns string type for a service object of type 'ToggleFilterProcessing-request"
  "robot_localization_custom/ToggleFilterProcessingRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ToggleFilterProcessing-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ToggleFilterProcessing-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_localization_custom-srv:<ToggleFilterProcessing-response> is deprecated: use robot_localization_custom-srv:ToggleFilterProcessing-response instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <ToggleFilterProcessing-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_localization_custom-srv:status-val is deprecated.  Use robot_localization_custom-srv:status instead.")
  (status m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ToggleFilterProcessing-response>)))
  ...
  "robot_localization_custom/ToggleFilterProcessingResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ToggleFilterProcessing-response)))
  "Returns string type for a service object of type 'ToggleFilterProcessing-response"
  "robot_localization_custom/ToggleFilterProcessingResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ToggleFilterProcessing)))
  ...
  "robot_localization_custom/ToggleFilterProcessing")