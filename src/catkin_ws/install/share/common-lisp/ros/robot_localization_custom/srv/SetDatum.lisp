...
(cl:defmethod cl:initialize-instance :after ((m <SetDatum-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetDatum-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_localization_custom-srv:<SetDatum-request> is deprecated: use robot_localization_custom-srv:SetDatum-request instead.")))

(cl:ensure-generic-function 'geo_pose-val :lambda-list '(m))
(cl:defmethod geo_pose-val ((m <SetDatum-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_localization_custom-srv:geo_pose-val is deprecated.  Use robot_localization_custom-srv:geo_pose instead.")
  (geo_pose m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetDatum-request>)))
  ...
  "robot_localization_custom/SetDatumRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetDatum-request)))
  "Returns string type for a service object of type 'SetDatum-request"
  "robot_localization_custom/SetDatumRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetDatum-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetDatum-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_localization_custom-srv:<SetDatum-response> is deprecated: use robot_localization_custom-srv:SetDatum-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetDatum-response>)))
  ...
  "robot_localization_custom/SetDatumResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetDatum-response)))
  "Returns string type for a service object of type 'SetDatum-response"
  "robot_localization_custom/SetDatumResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetDatum)))
  ...
  "robot_localization_custom/SetDatum")