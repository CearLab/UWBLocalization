...
(cl:in-package robot_localization_custom-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <GetState-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetState-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_localization_custom-srv:<GetState-request> is deprecated: use robot_localization_custom-srv:GetState-request instead.")))

(cl:ensure-generic-function 'time_stamp-val :lambda-list '(m))
(cl:defmethod time_stamp-val ((m <GetState-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_localization_custom-srv:time_stamp-val is deprecated.  Use robot_localization_custom-srv:time_stamp instead.")
  (time_stamp m))

(cl:ensure-generic-function 'frame_id-val :lambda-list '(m))
(cl:defmethod frame_id-val ((m <GetState-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_localization_custom-srv:frame_id-val is deprecated.  Use robot_localization_custom-srv:frame_id instead.")
  (frame_id m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetState-request>)))
  ...
  "robot_localization_custom/GetStateRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetState-request)))
  "Returns string type for a service object of type 'GetState-request"
  "robot_localization_custom/GetStateRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GetState-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetState-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_localization_custom-srv:<GetState-response> is deprecated: use robot_localization_custom-srv:GetState-response instead.")))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <GetState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_localization_custom-srv:state-val is deprecated.  Use robot_localization_custom-srv:state instead.")
  (state m))

(cl:ensure-generic-function 'covariance-val :lambda-list '(m))
(cl:defmethod covariance-val ((m <GetState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_localization_custom-srv:covariance-val is deprecated.  Use robot_localization_custom-srv:covariance instead.")
  (covariance m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetState-response>)))
  ...
  "robot_localization_custom/GetStateResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetState-response)))
  "Returns string type for a service object of type 'GetState-response"
  "robot_localization_custom/GetStateResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetState)))
  ...
  "robot_localization_custom/GetState")