...
(cl:defmethod cl:initialize-instance :after ((m <FromLL-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FromLL-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_localization_custom-srv:<FromLL-request> is deprecated: use robot_localization_custom-srv:FromLL-request instead.")))

(cl:ensure-generic-function 'll_point-val :lambda-list '(m))
(cl:defmethod ll_point-val ((m <FromLL-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_localization_custom-srv:ll_point-val is deprecated.  Use robot_localization_custom-srv:ll_point instead.")
  (ll_point m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FromLL-request>)))
  ...
  "robot_localization_custom/FromLLRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FromLL-request)))
  "Returns string type for a service object of type 'FromLL-request"
  "robot_localization_custom/FromLLRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <FromLL-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FromLL-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_localization_custom-srv:<FromLL-response> is deprecated: use robot_localization_custom-srv:FromLL-response instead.")))

(cl:ensure-generic-function 'map_point-val :lambda-list '(m))
(cl:defmethod map_point-val ((m <FromLL-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_localization_custom-srv:map_point-val is deprecated.  Use robot_localization_custom-srv:map_point instead.")
  (map_point m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FromLL-response>)))
  ...
  "robot_localization_custom/FromLLResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FromLL-response)))
  "Returns string type for a service object of type 'FromLL-response"
  "robot_localization_custom/FromLLResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FromLL)))
  ...
  "robot_localization_custom/FromLL")