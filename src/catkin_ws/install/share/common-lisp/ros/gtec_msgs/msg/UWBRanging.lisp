...
(cl:defclass <UWBRanging> (roslisp-msg-protocol:ros-message)
  ((anchorId
    :reader anchorId
    :initarg :anchorId
    :type cl:fixnum
   ...
   (rawrange
    ...
    :initform 0)
   (biasCorrection
    :reader biasCorrection
    :initarg :biasCorrection
    :type cl:integer
    :initform 0)
   (seq
    :reader seq
...
(cl:defclass UWBRanging (<UWBRanging>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <UWBRanging>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'UWBRanging)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gtec_msgs-msg:<UWBRanging> is deprecated: use gtec_msgs-msg:UWBRanging instead.")))

(cl:ensure-generic-function 'anchorId-val :lambda-list '(m))
(cl:defmethod anchorId-val ((m <UWBRanging>))
...
(cl:defmethod tagId-val ((m <UWBRanging>))
...
(cl:defmethod range-val ((m <UWBRanging>))
...
(cl:defmethod rawrange-val ((m <UWBRanging>))
...
(cl:ensure-generic-function 'biasCorrection-val :lambda-list '(m))
(cl:defmethod biasCorrection-val ((m <UWBRanging>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gtec_msgs-msg:biasCorrection-val is deprecated.  Use gtec_msgs-msg:biasCorrection instead.")
  (biasCorrection m))

(cl:ensure-generic-function 'seq-val :lambda-list '(m))
(cl:defmethod seq-val ((m <UWBRanging>))
...
(cl:defmethod maxNoise-val ((m <UWBRanging>))
...
(cl:defmethod stdNoise-val ((m <UWBRanging>))
...
(cl:defmethod firstPathAmp1-val ((m <UWBRanging>))
...
(cl:defmethod firstPathAmp2-val ((m <UWBRanging>))
...
(cl:defmethod firstPathAmp3-val ((m <UWBRanging>))
...
(cl:defmethod maxGrowthCIR-val ((m <UWBRanging>))
...
(cl:defmethod rxPreamCount-val ((m <UWBRanging>))
...
(cl:defmethod firstPath-val ((m <UWBRanging>))
...
(cl:defmethod channel-val ((m <UWBRanging>))
...
(cl:defmethod prf-val ((m <UWBRanging>))
...
(cl:defmethod datarate-val ((m <UWBRanging>))
...
(cl:defmethod preambleLength-val ((m <UWBRanging>))
...
(cl:defmethod pacSize-val ((m <UWBRanging>))
...
(cl:defmethod errorEstimation-val ((m <UWBRanging>))
  ...
  (errorEstimation m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <UWBRanging>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'biasCorrection)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <UWBRanging>) istream)
  "Deserializes a message object of type '<UWBRanging>"
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'biasCorrection) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<UWBRanging>)))
  "Returns string type for a message object of type '<UWBRanging>"
  "gtec_msgs/UWBRanging")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'UWBRanging)))
  "Returns string type for a message object of type 'UWBRanging"
  "gtec_msgs/UWBRanging")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<UWBRanging>)))
  "Returns md5sum for a message object of type '<UWBRanging>"
  "a2ecb2ec6e49b5856c7d150d936a536b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'UWBRanging)))
  "Returns md5sum for a message object of type 'UWBRanging"
  "a2ecb2ec6e49b5856c7d150d936a536b")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<UWBRanging>)))
  "Returns full string definition for message of type '<UWBRanging>"
  (cl:format cl:nil "int16 anchorId~%int16 tagId~%int32 range~%int32 rawrange~%int32 biasCorrection~%int32 seq~%int32 maxNoise~%int32 stdNoise~%int32 firstPathAmp1~%int32 firstPathAmp2~%int32 firstPathAmp3~%int32 maxGrowthCIR~%int32 rxPreamCount~%int32 firstPath~%float64 channel~%int32 prf~%float64 datarate~%int32 preambleLength~%int32 pacSize~%float64 errorEstimation~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'UWBRanging)))
  "Returns full string definition for message of type 'UWBRanging"
  (cl:format cl:nil "int16 anchorId~%int16 tagId~%int32 range~%int32 rawrange~%int32 biasCorrection~%int32 seq~%int32 maxNoise~%int32 stdNoise~%int32 firstPathAmp1~%int32 firstPathAmp2~%int32 firstPathAmp3~%int32 maxGrowthCIR~%int32 rxPreamCount~%int32 firstPath~%float64 channel~%int32 prf~%float64 datarate~%int32 preambleLength~%int32 pacSize~%float64 errorEstimation~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <UWBRanging>))
  (cl:+ 0
     2
     2
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <UWBRanging>))
  ...
  (cl:list 'UWBRanging
    ...
    (cl:cons ':biasCorrection (biasCorrection msg))
    (cl:cons ':seq (seq msg))
