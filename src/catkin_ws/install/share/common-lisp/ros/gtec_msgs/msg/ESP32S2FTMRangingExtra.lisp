...
;//! \htmlinclude ESP32S2FTMRangingExtra.msg.html

(cl:defclass <ESP32S2FTMRangingExtra> (roslisp-msg-protocol:ros-message)
  ((anchorId
    :reader anchorId
    :initarg :anchorId
    :type cl:string
...
(cl:defclass ESP32S2FTMRangingExtra (<ESP32S2FTMRangingExtra>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <ESP32S2FTMRangingExtra>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'ESP32S2FTMRangingExtra)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gtec_msgs-msg:<ESP32S2FTMRangingExtra> is deprecated: use gtec_msgs-msg:ESP32S2FTMRangingExtra instead.")))

(cl:ensure-generic-function 'anchorId-val :lambda-list '(m))
(cl:defmethod anchorId-val ((m <ESP32S2FTMRangingExtra>))
...
(cl:defmethod rtt_est-val ((m <ESP32S2FTMRangingExtra>))
...
(cl:defmethod rtt_raw-val ((m <ESP32S2FTMRangingExtra>))
...
(cl:defmethod dist_est-val ((m <ESP32S2FTMRangingExtra>))
...
(cl:ensure-generic-function 'own_est-val :lambda-list '(m))
(cl:defmethod own_est-val ((m <ESP32S2FTMRangingExtra>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gtec_msgs-msg:own_est-val is deprecated.  Use gtec_msgs-msg:own_est instead.")
  (own_est m))

(cl:ensure-generic-function 'num_frames-val :lambda-list '(m))
(cl:defmethod num_frames-val ((m <ESP32S2FTMRangingExtra>))
...
(cl:defmethod frames-val ((m <ESP32S2FTMRangingExtra>))
  ...
  (frames m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ESP32S2FTMRangingExtra>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'own_est))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ESP32S2FTMRangingExtra>) istream)
  "Deserializes a message object of type '<ESP32S2FTMRangingExtra>"
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'own_est) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ESP32S2FTMRangingExtra>)))
  "Returns string type for a message object of type '<ESP32S2FTMRangingExtra>"
  "gtec_msgs/ESP32S2FTMRangingExtra")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ESP32S2FTMRangingExtra)))
  "Returns string type for a message object of type 'ESP32S2FTMRangingExtra"
  "gtec_msgs/ESP32S2FTMRangingExtra")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ESP32S2FTMRangingExtra>)))
  "Returns md5sum for a message object of type '<ESP32S2FTMRangingExtra>"
  "6ee26c63cfee1bff93dc663fa5bfe36d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ESP32S2FTMRangingExtra)))
  "Returns md5sum for a message object of type 'ESP32S2FTMRangingExtra"
  "6ee26c63cfee1bff93dc663fa5bfe36d")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ESP32S2FTMRangingExtra>)))
  "Returns full string definition for message of type '<ESP32S2FTMRangingExtra>"
  (cl:format cl:nil "string anchorId~%int32 rtt_est~%int32 rtt_raw~%float32 dist_est~%float32 own_est~%int32 num_frames~%gtec_msgs/ESP32S2FTMFrame[] frames~%~%================================================================================~%MSG: gtec_msgs/ESP32S2FTMFrame~%int32 rssi~%int32 rtt~%int64 t1~%int64 t2~%int64 t3~%int64 t4~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ESP32S2FTMRangingExtra)))
  "Returns full string definition for message of type 'ESP32S2FTMRangingExtra"
  (cl:format cl:nil "string anchorId~%int32 rtt_est~%int32 rtt_raw~%float32 dist_est~%float32 own_est~%int32 num_frames~%gtec_msgs/ESP32S2FTMFrame[] frames~%~%================================================================================~%MSG: gtec_msgs/ESP32S2FTMFrame~%int32 rssi~%int32 rtt~%int64 t1~%int64 t2~%int64 t3~%int64 t4~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ESP32S2FTMRangingExtra>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ESP32S2FTMRangingExtra>))
  "Converts a ROS message object to a list"
  (cl:list 'ESP32S2FTMRangingExtra
    (cl:cons ':anchorId (anchorId msg))
    (cl:cons ':rtt_est (rtt_est msg))
    (cl:cons ':rtt_raw (rtt_raw msg))
    (cl:cons ':dist_est (dist_est msg))
    (cl:cons ':own_est (own_est msg))
