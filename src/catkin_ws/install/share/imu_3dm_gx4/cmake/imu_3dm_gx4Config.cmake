...
if("FALSE" STREQUAL "TRUE")
  set(imu_3dm_gx4_SOURCE_PREFIX /home/ros/workspace/catkin_ws/src/imu_3dm_gx4)
  set(imu_3dm_gx4_DEVEL_PREFIX /home/ros/workspace/catkin_ws/devel)
  ...
  set(imu_3dm_gx4_INSTALL_PREFIX /home/ros/workspace/catkin_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Kartik Mohta <kartikmohta@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'imu_3dm_gx4' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT imu_3dm_gx4_NUM_DUMMY_TARGETS)
      set(imu_3dm_gx4_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::imu_3dm_gx4::wrapped-linker-option${imu_3dm_gx4_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR imu_3dm_gx4_NUM_DUMMY_TARGETS "${imu_3dm_gx4_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::imu_3dm_gx4::wrapped-linker-option${imu_3dm_gx4_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND imu_3dm_gx4_LIBRARIES "${interface_target_name}")
