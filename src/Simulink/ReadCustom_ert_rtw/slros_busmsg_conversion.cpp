...
// Conversions between SL_Bus_ReadCustom_geometry_msgs_Point and geometry_msgs::Point

void convertFromBus(geometry_msgs::Point* msgPtr, SL_Bus_ReadCustom_geometry_msgs_Point const* busPtr)
{
...
void convertToBus(SL_Bus_ReadCustom_geometry_msgs_Point* busPtr, geometry_msgs::Point const* msgPtr)
{
  const std::string rosMessageType("geometry_msgs/Point");
...
// Conversions between SL_Bus_ReadCustom_geometry_msgs_Pose and geometry_msgs::Pose

void convertFromBus(geometry_msgs::Pose* msgPtr, SL_Bus_ReadCustom_geometry_msgs_Pose const* busPtr)
{
...
void convertToBus(SL_Bus_ReadCustom_geometry_msgs_Pose* busPtr, geometry_msgs::Pose const* msgPtr)
{
  const std::string rosMessageType("geometry_msgs/Pose");
...
// Conversions between SL_Bus_ReadCustom_geometry_msgs_PoseWithCovariance and geometry_msgs::PoseWithCovariance

void convertFromBus(geometry_msgs::PoseWithCovariance* msgPtr, SL_Bus_ReadCustom_geometry_msgs_PoseWithCovariance const* busPtr)
{
...
void convertToBus(SL_Bus_ReadCustom_geometry_msgs_PoseWithCovariance* busPtr, geometry_msgs::PoseWithCovariance const* msgPtr)
{
  const std::string rosMessageType("geometry_msgs/PoseWithCovariance");
...
// Conversions between SL_Bus_ReadCustom_geometry_msgs_Twist and geometry_msgs::Twist

void convertFromBus(geometry_msgs::Twist* msgPtr, SL_Bus_ReadCustom_geometry_msgs_Twist const* busPtr)
{
...
void convertToBus(SL_Bus_ReadCustom_geometry_msgs_Twist* busPtr, geometry_msgs::Twist const* msgPtr)
{
  const std::string rosMessageType("geometry_msgs/Twist");
...
// Conversions between SL_Bus_ReadCustom_geometry_msgs_TwistWithCovariance and geometry_msgs::TwistWithCovariance

void convertFromBus(geometry_msgs::TwistWithCovariance* msgPtr, SL_Bus_ReadCustom_geometry_msgs_TwistWithCovariance const* busPtr)
{
...
void convertToBus(SL_Bus_ReadCustom_geometry_msgs_TwistWithCovariance* busPtr, geometry_msgs::TwistWithCovariance const* msgPtr)
{
  const std::string rosMessageType("geometry_msgs/TwistWithCovariance");
...
// Conversions between SL_Bus_ReadCustom_nav_msgs_Odometry and nav_msgs::Odometry

void convertFromBus(nav_msgs::Odometry* msgPtr, SL_Bus_ReadCustom_nav_msgs_Odometry const* busPtr)
{
...
void convertToBus(SL_Bus_ReadCustom_nav_msgs_Odometry* busPtr, nav_msgs::Odometry const* msgPtr)
{
  const std::string rosMessageType("nav_msgs/Odometry");
