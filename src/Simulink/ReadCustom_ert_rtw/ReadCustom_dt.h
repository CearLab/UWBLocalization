...
static uint_T rtDataTypeSizes[] = {
  ...
  sizeof(SL_Bus_ReadCustom_geometry_msgs_Point),
  sizeof(SL_Bus_ReadCustom_geometry_msgs_Quaternion),
  sizeof(SL_Bus_ReadCustom_geometry_msgs_Pose),
  sizeof(SL_Bus_ReadCustom_geometry_msgs_PoseWithCovariance),
  sizeof(SL_Bus_ReadCustom_geometry_msgs_Vector3),
  sizeof(SL_Bus_ReadCustom_geometry_msgs_Twist),
  sizeof(SL_Bus_ReadCustom_geometry_msgs_TwistWithCovariance),
  sizeof(SL_Bus_ReadCustom_nav_msgs_Odometry),
...
static const char_T * rtDataTypeNames[] = {
  ...
  "SL_Bus_ReadCustom_geometry_msgs_Point",
  "SL_Bus_ReadCustom_geometry_msgs_Quaternion",
  "SL_Bus_ReadCustom_geometry_msgs_Pose",
  "SL_Bus_ReadCustom_geometry_msgs_PoseWithCovariance",
  "SL_Bus_ReadCustom_geometry_msgs_Vector3",
  "SL_Bus_ReadCustom_geometry_msgs_Twist",
  "SL_Bus_ReadCustom_geometry_msgs_TwistWithCovariance",
  "SL_Bus_ReadCustom_nav_msgs_Odometry",
...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&ReadCustom_B.Y), 0, 0, 3 }
  ,

  { (char_T *)(&ReadCustom_DW.obj), 26, 0, 1 },
...
static DataTypeTransition rtPTransitions[] = {
  { (char_T *)(&ReadCustom_P.Out1_Y0), 25, 0, 1 },

  { (char_T *)(&ReadCustom_P.Constant_Value), 25, 0, 1 },
