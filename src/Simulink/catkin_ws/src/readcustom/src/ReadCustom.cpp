...
void ReadCustom_step(void)
{
  ...
  if (b_varargout_1) {
    ...
    ReadCustom_B.Z = ReadCustom_B.b_varargout_2.LinearAcceleration.Z;

    /* SignalConversion generated from: '<S1>/Bus Selector' */
    ReadCustom_B.Y = ReadCustom_B.b_varargout_2.LinearAcceleration.Y;

    /* SignalConversion generated from: '<S1>/Bus Selector' */
    ReadCustom_B.X = ReadCustom_B.b_varargout_2.LinearAcceleration.X;
...
{
  /* Registration code */
  rtmSetTFinal(ReadCustom_M, 30.0);
  ReadCustom_M->Timing.stepSize0 = 0.01;

  /* External mode info */
  ReadCustom_M->Sizes.checksums[0] = (1755198135U);
  ReadCustom_M->Sizes.checksums[1] = (1029483213U);
  ReadCustom_M->Sizes.checksums[2] = (61093029U);
  ReadCustom_M->Sizes.checksums[3] = (3838488544U);
...

  {
    ...
    static const char_T tmp[9] = { '/', 'i', 'm', 'u', '/', 'd', 'a', 't', 'a' };
   ...
   *  Outport: '<S1>/Y'
   */
  ReadCustom_B.Y = ReadCustom_P.Y_Y0;

  /* SystemInitialize for SignalConversion generated from: '<S1>/Bus Selector' incorporates:
   *  Outport: '<S1>/Z'
   */
  ReadCustom_B.Z = ReadCustom_P.Z_Y0;
