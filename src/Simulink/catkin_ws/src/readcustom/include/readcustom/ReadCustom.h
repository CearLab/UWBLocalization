...
struct B_ReadCustom_T {
  SL_Bus_ReadCustom_sensor_msgs_Imu b_varargout_2;
  real_T Z;
  real_T Y;
  real_T X;
};
...
struct P_ReadCustom_T_ {
  SL_Bus_ReadCustom_sensor_msgs_Imu Out1_Y0;/* Computed Parameter: Out1_Y0
                                             * Referenced by: '<S3>/Out1'
                                             */
  SL_Bus_ReadCustom_sensor_msgs_Imu Constant_Value;/* Computed Parameter: Constant_Value
