...
"""autogenerated by genpy from gtec_msgs/ESP32S2FTMRanging.msg. Do not edit."""
import codecs
import sys
...
class ESP32S2FTMRanging(genpy.Message):
  _md5sum = "300ca8dcfb5379b480056ad93a9bfd81"
  _type = "gtec_msgs/ESP32S2FTMRanging"
...
int64 t3
int64 t4"""
  __slots__ = ['anchorId','rtt_est','rtt_raw','dist_est','num_frames','frames']
  _slot_types = ['string','int32','int32','float32','int32','gtec_msgs/ESP32S2FTMFrame[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       anchorId,rtt_est,rtt_raw,dist_est,num_frames,frames
    ...
    """
    if args or kwds:
      super(ESP32S2FTMRanging, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2ifi().pack(_x.rtt_est, _x.rtt_raw, _x.dist_est, _x.num_frames))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.rtt_est, _x.rtt_raw, _x.dist_est, _x.num_frames,) = _get_struct_2ifi().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.frames = []
