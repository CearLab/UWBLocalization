...
class RadarRangeDoppler {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.header = null;
      this.numRangeBins = null;
      this.numDopplerBins = null;
      this.data = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('numDopplerBins')) {
        this.numDopplerBins = initObj.numDopplerBins
      }
      else {
        this.numDopplerBins = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [numDopplerBins]
    bufferOffset = _serializer.int16(obj.numDopplerBins, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RadarRangeDoppler(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [numRangeBins]
    data.numRangeBins = _deserializer.int16(buffer, bufferOffset);
    // Deserialize message field [numDopplerBins]
    data.numDopplerBins = _deserializer.int16(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RadarRangeDoppler(null);
    ...
    if (msg.numDopplerBins !== undefined) {
      resolved.numDopplerBins = msg.numDopplerBins;
    }
    else {
      resolved.numDopplerBins = 0
    }
...
module.exports = RadarRangeDoppler;
